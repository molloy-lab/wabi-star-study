...
def main():
    ...
    result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/bio_result/cassiopeia-greedy'
    ...
    for folder in folders:
        ...
        star_cdp_tree_path = tree_path = os.path.join(cur_res_path, 'cassiopeia_greedy.tre')

...
def main():
    ...
    for folder in folders:
        ...
        pruned_tree = os.path.join(os.path.join(cur_res_path,'output'), 'startle_tree.newick')
        ...
        replaced_tree_path = os.path.join(cur_res_path, 'replaced_startle_tree.newick')

...
def write_nni_sbatch(startle_exe: str, cmat: str, priors: str, sbatch_file: str, start_tree: str):
    ...
    rows_to_wrtie = ['#!/bin/bash', 
                    ...
                    ' '.join([time,'-v','-o','original_cmat_to_nj_nni_usage.log',startle_exe,'large',cmat,priors, start_tree, '--output', 'original_cmat_to_nj_nni',\
                    '&>','original_cmat_to_nj_nni.log','2>&1'])
                    ]

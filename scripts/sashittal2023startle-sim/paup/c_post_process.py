...
def main():
    ...
    for folder in folders:
        ...
        for rep in reps:
            ...
            all_trees_path = os.path.join(cur_res_rep_path, "all_trees.trees")
            all_paup_res_path = os.path.join(cur_res_rep_path, 'paup_trees.trees')
            nmap_file = os.path.join(cur_res_rep_path, 'taxon_map.csv')

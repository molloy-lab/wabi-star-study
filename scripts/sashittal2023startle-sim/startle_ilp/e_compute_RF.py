...
def main():
    ...
    for folder in folders:
        ...
        for rep in reps:
            ...
            # , '-t1', true_tree_path, '-t2', ilp_tree_path, '-c1','0', '-c2', '0', '-m', cmat_path ,'-r', '0'], capture_output=True, text=True)
                score_res = sp.run(['python3', comp_exe
            , '-t1', true_tree_path, '-t2', ilp_tree_path, '-c1','1', '-c2', '1', '-m', cmat_path ,'-r', '0'], capture_output=True, text=True)
